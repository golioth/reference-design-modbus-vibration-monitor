...
Golioth Reference Design - Modbus CO₂ Monitor
#############################################

This repository contains the firmware source code and `pre-built release
firmware images <releases_>`_ for the Golioth Modbus CO₂ Monitor reference
design.

The full project details are available on the `Modbus CO₂ Monitor Project
Page`_, including follow-along guides for building an IoT Modbus CO₂ Monitor
...
.. list-table:: **Custom Golioth Hardware**
   ...
   * - .. image:: https://placehold.co/600x400
     ...
     - `Modbus CO₂ Monitor Project Page`_

Firmware Overview
*****************

This reference design firmware demonstrates how to interface with a
`Non-dispersive Infra-red (NDIR)`_ CO₂ sensor via the Modbus protocol and send
"true" CO₂ measurements to the cloud using the Golioth IoT platform.

The following environmental parameters can be monitored:
...
.. code-block:: shell
   ...
   cd ~
   mkdir golioth-reference-design-modbus-co2-monitor
   python -m venv golioth-reference-design-modbus-co2-monitor/.venv
   source golioth-reference-design-modbus-co2-monitor/.venv/bin/activate
...
.. code-block:: shell
   ...
   cd ~/golioth-reference-design-modbus-co2-monitor
   west init -m git@github.com:golioth/reference-design-modbus-co2-monitor.git .
   west update
   west zephyr-export
...
.. _Modbus CO₂ Monitor Project Page: https://projects.golioth.io/reference-designs/modbus-co2-monitor
.. _nRF9160 DK Follow-Along Guide: https://projects.golioth.io/reference-designs/modbus-co2-monitor/guide-nrf9160-dk
.. _releases: https://github.com/golioth/reference-design-modbus-co2-monitor/releases
...
.. _Non-dispersive Infra-red (NDIR): https://en.wikipedia.org/wiki/Nondispersive_infrared_sensor
